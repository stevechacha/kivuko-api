...
urlpatterns = [
    ...
    path("users/me/rewards", MyRewardsView.as_view(), name="my-rewards"),
    ...
    path("stories/archive", OralStoriesArchiveView.as_view(), name="stories-archive"),
    ...
    path("partner/radio-script", RadioBroadcastScriptView.as_view(), name="radio-script"),
